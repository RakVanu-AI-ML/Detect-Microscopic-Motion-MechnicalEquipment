...
def imagePrediction(): #frameA_Image, frameB_Image, magnificationFactorValue):
    frameA_Image = []
    frameB_Image = []   
    ...
    magnificationFactorValue = st.slider('Please select Magnification Factor from slider', min_value=1, max_value=100)
